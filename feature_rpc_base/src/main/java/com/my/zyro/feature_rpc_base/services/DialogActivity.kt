 ...
 *  ******************************************************************
 *  *  * Copyright (C) 2022
 *  *  * DialogActivity.kt is part of Zyro
...
class DialogActivity : Activity() {
    ...
    private fun showDialog() {
        ...
        val dialog = MaterialAlertDialogBuilder(ContextThemeWrapper(this, com.my.zyro.feature_rpc_base.R.style.MyTileDialogTheme))
