 ...
 *  ******************************************************************
 *  *  * Copyright (C) 2022
 *  *  * ZyroTileService.kt is part of Zyro
...
class ZyroTileService : TileService() {
    ...
    private fun createRpcChoosingDialog(ctx: Context): Dialog {
        ...
        return MaterialAlertDialogBuilder(ContextThemeWrapper(ctx, com.my.zyro.feature_rpc_base.R.style.MyTileDialogTheme))
