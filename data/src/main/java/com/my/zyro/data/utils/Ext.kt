...
import com.my.zyro.data.remote.ApiResponse
import com.my.zyro.data.remote.ExternalAsset
import com.my.zyro.data.remote.ImgurResponse
...
fun Context.shareFile(file: File?) {
    if (file == null) return
    val uri = FileProvider.getUriForFile(this, "com.my.zyro.provider", file)
